...
export async function loader({ request, params }: Route.LoaderArgs) {
  ...
  return {
    ...
    canCreateProofRequests: hasPermission(staffUser, "proof_requests.create"),
    canViewProofRequests: hasPermission(staffUser, "proof_requests.view"),
    canResendProofRequests: hasPermission(staffUser, "proof_requests.resend"),
    canRevokeProofRequests: hasPermission(staffUser, "proof_requests.revoke"),
    ...
    canCancelFreight: hasPermission(staffUser, "freight_shipments.cancel"),
    canViewWarehousePicks: hasPermission(staffUser, "warehouse_picks.view"),
    canViewExceptionCases: hasPermission(staffUser, "exception_cases.view"),
    canCreateExceptionCases: hasPermission(staffUser, "exception_cases.create"),
  };
}
